...
- Django Rest Framework simple JWT (https://django-rest-framework-simplejwt.readthedocs.io/en/latest/getting_started.html#cryptographic-dependencies-optional)
